    ...
    SingleSelect2 = clazz(AbstractSelect2, {
		...
		createContainer: function () {
            var container = $("<div></div>", {
               ...
               // "    <a href='javascript:;' onclick='return false;' class='select2-choice'>",
               "<div onclick='return false;' class='select2-choice hover'>",
                "   <span></span><abbr class='select2-search-choice-close' style='display:none;'></abbr>",
                "   <div><b></b></div>" ,
               // "</a>",
               "</div>",
                "    <div class='select2-drop select2-offscreen padding-top'>" ,
