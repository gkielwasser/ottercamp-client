!function($, wysi) {
    ...
    var templates = {
        ...
        "emphasis":    "<li>" +
                           "<div class='btn-group'>" +
                               "<a class='btn' data-wysihtml5-command='bold' title='CTRL+B'>Gras</a>" +
                               "<a class='btn' data-wysihtml5-command='italic' title='CTRL+I'>Italique</a>" +
                               "<a class='btn' data-wysihtml5-command='underline' title='CTRL+U'>Souligné</a>" +
                           "</div>" +
                       "</li>",
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
                               ...
                               "<a class='btn' data-wysihtml5-command='Outdent' title='Non indenté'><i class='icon-indent-right'></i></a>" +
                               "<a class='btn' data-wysihtml5-command='Indent' title='Indenté'><i class='icon-indent-left'></i></a>" +
                           "</div>" +
                       "</li>",
        "link":        "<li>" +
                           "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                               ...
                               "<div class='modal-footer'>" +
                                   ...
                                   "<a href='#' class='btn btn-primary2' data-dismiss='modal'>Inserer un lien</a>" +
                               "</div>" +
                           "</div>" +
